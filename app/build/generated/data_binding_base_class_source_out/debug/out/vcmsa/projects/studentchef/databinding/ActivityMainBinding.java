...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull LinearLayout rootView, @NonNull LinearLayout mainLayout,
      ...
      @NonNull TextView tvAppTitle, @NonNull TextView tvInstructions,
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((LinearLayout) rootView, mainLayout, recyclerView, searchView,
          tvAppTitle, tvInstructions, tvQuestion);
    }
